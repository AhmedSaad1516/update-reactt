...
function Subscription(){
    ...
    return (
        ...
        <RequestsHeader titleHeader='Subscription' titleHeader2='Subscription' /> 
        </div>
...
<BtnAudit className="myBtnNew-info " childrenTitle="Accept"  childrenIcon={<i className="m-1 fa-solid fa-check"></i> } />
